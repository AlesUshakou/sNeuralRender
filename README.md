# sNeuralRender — NVIDIA DLSS 5 Neural Rendering inside Nuke

A native Nuke plugin that runs NVIDIA's **DLSS 5 Neural Rendering** (NGX feature 18) on your
footage directly in the node graph: global structure/tone controls, the runtime's automask,
any number of your own masks with their own strengths, and temporal history driven by
NVIDIA Optical Flow or your own motion vectors.
...
- It ships inside NVIDIA's DLSS 5 packages and inside applications that bundle the DLSS 5
  ...
  **310.8.0**; it is, for example, the file `neural-runtime\nvngx_dlssnr.dll` of the
  [DLSS 5 video player](https://github.com/2600th/dlss5-video-player) release package.
